    ...
    function main() {
        jQuery(document).ready(function($) {
            ...
            directLineConn = window.WebChat.createDirectLine({ 
                secret_qa: 'J2FkNlHyJUY.xMgsZKF-vJk1kcGUsYqpFGT4VwMUCUwHrloIcEQctGk',
                secret_dev: 'X3-5HYsVEf4.cwA.n78.-OJsgUASThdxjH0psyq_5m0rrgxhHvXOJ_m4PvgVk2E',
                secret: 'J2FkNlHyJUY.xMgsZKF-vJk1kcGUsYqpFGT4VwMUCUwHrloIcEQctGk',
                user: user,
                bot: { id: 'Bot' }
                ,resize: 'detect'
            });
